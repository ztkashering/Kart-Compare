...
STORE_META = {
    ...
    "aisle-9": {
        ...
        "note": (
            ...
            "zip code like the other stores here allow. So instead of "
            "Aisle 9's full weekly specials list, this page shows every "
            "genuinely marked-down item (confirmed by an actual \"Special\" "
            "badge, not just a featured listing) found on their public "
            "homepage across multiple checks — there are certainly more "
            "real deals at Aisle 9 than shown here, and this list will "
            "grow as more turn up. Aisle 9 doesn't publish a sale end date "
...
.card .add-btn {
  ...
  border-radius: 10px; padding: 10px 10px; font-size: 13px; cursor: pointer; font-weight: 700;
